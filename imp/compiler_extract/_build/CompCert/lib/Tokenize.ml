...
and __ocaml_lex_tokenize_rec acc lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 22 "CompCert/lib/Tokenize.mll"
                        ( List.rev acc )
# 140 "CompCert/lib/Tokenize.ml"

  | 1 ->
# 23 "CompCert/lib/Tokenize.mll"
                             ( tokenize acc lexbuf )
# 145 "CompCert/lib/Tokenize.ml"

  | 2 ->
# 24 "CompCert/lib/Tokenize.mll"
                        ( tok_dquote acc (Buffer.create 16) lexbuf )
# 150 "CompCert/lib/Tokenize.ml"

  | 3 ->
# 25 "CompCert/lib/Tokenize.mll"
                        ( tok_squote acc (Buffer.create 16) lexbuf )
# 155 "CompCert/lib/Tokenize.ml"

  | 4 ->
let
# 26 "CompCert/lib/Tokenize.mll"
                               s
# 161 "CompCert/lib/Tokenize.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 27 "CompCert/lib/Tokenize.mll"
                        ( tokenize (s :: acc) lexbuf )
# 165 "CompCert/lib/Tokenize.ml"

  | 5 ->
let
# 28 "CompCert/lib/Tokenize.mll"
         c
# 171 "CompCert/lib/Tokenize.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 28 "CompCert/lib/Tokenize.mll"
                        ( tokenize (String.make 1 c :: acc) lexbuf )
# 175 "CompCert/lib/Tokenize.ml"
...
and __ocaml_lex_tok_dquote_rec acc buf lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 31 "CompCert/lib/Tokenize.mll"
                        ( tokenize (Buffer.contents buf :: acc) lexbuf )
# 187 "CompCert/lib/Tokenize.ml"

  | 1 ->
# 32 "CompCert/lib/Tokenize.mll"
                        ( Buffer.add_char buf '\t'; tok_dquote acc buf lexbuf )
# 192 "CompCert/lib/Tokenize.ml"

  | 2 ->
# 33 "CompCert/lib/Tokenize.mll"
                        ( Buffer.add_char buf '\n'; tok_dquote acc buf lexbuf )
# 197 "CompCert/lib/Tokenize.ml"

  | 3 ->
# 34 "CompCert/lib/Tokenize.mll"
                        ( Buffer.add_char buf '\r'; tok_dquote acc buf lexbuf )
# 202 "CompCert/lib/Tokenize.ml"

  | 4 ->
let
# 35 "CompCert/lib/Tokenize.mll"
                           c
# 208 "CompCert/lib/Tokenize.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 36 "CompCert/lib/Tokenize.mll"
                        ( Buffer.add_char buf c; tok_dquote acc buf lexbuf )
# 212 "CompCert/lib/Tokenize.ml"

  | 5 ->
let
# 37 "CompCert/lib/Tokenize.mll"
         c
# 218 "CompCert/lib/Tokenize.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 37 "CompCert/lib/Tokenize.mll"
                        ( Buffer.add_char buf c; tok_dquote acc buf lexbuf )
# 222 "CompCert/lib/Tokenize.ml"
...
and __ocaml_lex_tok_squote_rec acc buf lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 40 "CompCert/lib/Tokenize.mll"
                        ( tokenize (Buffer.contents buf :: acc) lexbuf )
# 234 "CompCert/lib/Tokenize.ml"

  | 1 ->
let
# 41 "CompCert/lib/Tokenize.mll"
         c
# 240 "CompCert/lib/Tokenize.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 41 "CompCert/lib/Tokenize.mll"
                        ( Buffer.add_char buf c; tok_squote acc buf lexbuf )
# 244 "CompCert/lib/Tokenize.ml"
...
# 43 "CompCert/lib/Tokenize.mll"
 
let string s =
  tokenize [] (Lexing.from_string s)

# 256 "CompCert/lib/Tokenize.ml"
