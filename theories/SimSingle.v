...
Section SIM.
  ...
  | sim_event
      ...
      (SAFE: exists ev st_tgt1, _.(step) st_tgt0 (Some ev) st_tgt1)
      ...
      (SIM: forall st_tgt1
        ...
        ,
          exists st_src1, <<STEP: _.(step) st_src0 None st_src1>> /\
                                  <<SIM: exists i1, sim i1 st_src0 st_tgt1>>)
    :
      _sim sim i0 st_src0 st_tgt0
  | sim_angelic_both
      (SRT: _.(state_sort) st_src0 = angelic)
  ...
  Proof.
    ...
    - econs 1; et. i. exploit SIM; et. i; des. esplits; et.
    - econs 2; et. des. esplits; et.
    - econs 3; et. i. exploit SIM; et. i; des. esplits; et.
  ...
  Proof.
    ...
    punfold SIM. inv SIM.
    - des. exfalso. punfold SPIN. inv SPIN.
      + exploit STEP; et. i; des. ss.
      + des. clarify. exploit SIM0; et. i; des. ss.
    - des. pc SIM. gstep. econs 2; et. esplits; et. gbase. et.
    - punfold SPIN. inv SPIN; try rewrite SRT in *; ss. des; clarify.
      pc TL. exploit SIM0; et. i; des. pc SIM. eapply IH; et.
    - punfold SPIN. inv SPIN; ss.
      + gstep. econs 1; et. ii.
        TTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
        exploit SIM0; et.
        exploit STEP; et. i; des. clarify. pc TL.
        destruct (classic (exists ev st_tgt1, _.(step) st_tgt0 ev st_tgt1)).
        * des. exploit STEP; et. i; des. clarify. pc TL.
      pc TL. exploit SIM0; et. i; des. pc SIM. eapply IH; et.
      gstep. econs 2; et.
      
      pc SIM. gstep. econs 2; et. esplits; et.
